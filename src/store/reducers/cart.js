        ...
        case actionTypes.DEC_CART_ITEM_QUANTITY:
            {
                ...
                if (sameItem.length) {
                    ...
                    //if quantity of an item is zero then remove it from cart

                    if (quantity == 0) {

                        const itemToRemoveIndex = cartItems.indexOf(sameItem[0]);
                        cartItems = [...cartItems.slice(0, itemToRemoveIndex),
                        ...cartItems.slice(itemToRemoveIndex + 1)];
                    }
                    else {
